...
function authenticateSchema(req, res, next) {
    const schema = joi_1.default.object({ email: joi_1.default.string().required(), password: joi_1.default.string().required() });
...
function getAll(req, res, next) {
    account_service_1.default.getAll().then((accounts) => res.json(accounts)).catch(next);
}
